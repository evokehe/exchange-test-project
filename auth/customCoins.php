  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deleteModalLabel">Удалить кастомную монету</h5>

      </div>
      <div class="modal-body">
      <div class="form">
        <form action="logic/deleteCustomCoin" method="post">


            <div class="form-group">
                <label for="exampleInputEmail1">Айди монеты</label>
                <input type="number" class="form-control" id="coinId" name="coinId" aria-describedby="coinId" placeholder="Введи айди монеты">
            </div>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addModalLabel">Добавить новую кастомную монету</h5>

      </div>
      <div class="modal-body">
      <div class="form">
        <form action="logic/newCustomCoin" method="post">

            <div class="form-group">
                <label for="name">Название (к примеру - QIWI)</label>
                <input type="text" class="form-control" id="coin" name="coin" aria-describedby="coin" placeholder="Введи название">
            ...
            <div class="form-group">
                <label for="coinName">Цена (курс к доллару)</label>
                <input type="text" class="form-control" id="rate" name="rate" aria-describedby="cost" placeholder="Введи цену">
