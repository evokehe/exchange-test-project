...
$query = $pdo->prepare("SELECT * FROM pairs");
$query->execute();
$result = $query;
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deleteModalLabel">Удалить пару</h5>

      </div>
      <div class="modal-body">
      <div class="form">
        <form action="logic/deletePair" method="post">


            <div class="form-group">
                <label for="exampleInputEmail1">Айди пары</label>
                <input type="number" class="form-control" id="pairId" name="pairId" aria-describedby="pairId" placeholder="Введи айди пары">
            </div>

            <div class="form-group">
              <button type="submit" class="btn btn-danger w-100">Удалить пару</button>
            </div>
        </form>
    </div>
      </div>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addModalLabel">Добавить новую пару</h5>

      </div>
      <div class="modal-body">
      <div class="form">
        <form action="logic/newPair" method="post">

            <div class="form-group">
                <label for="exampleInputEmail1">Пара</label>
                <input type="text" class="form-control" id="pair" name="pair" aria-describedby="pair" placeholder="Например: BTCETH">
            ...
            <div class="form-group ">
            <button type="submit" class="btn btn-success w-100">Добавить пару</button>
            </div>
        </form>
    </div>
      </div>
