...
$query = $pdo->prepare("SELECT * FROM promocodes");
$query->execute();
$result = $query;
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deleteModalLabel">Удалить промокод</h5>

      </div>
      <div class="modal-body">
      <div class="form">
        <form action="logic/deletePromocode" method="post">


            <div class="form-group">
                <label for="exampleInputEmail1">Айди промокода</label>
                <input type="number" class="form-control" id="promocodeId" name="promocodeId" aria-describedby="promocodeId" placeholder="Введи айди промокода">
            </div>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addModalLabel">Добавить промокод</h5>

      </div>
      <div class="modal-body">
      <div class="form">
        <form action="logic/newPromocode" method="post">

            <div class="form-group">
                <label for="name">Промокод</label>
                <input type="text" class="form-control" id="code" name="code" aria-describedby="coin" placeholder="Например: FIRSTCHANGE5">
            ...
            <div class="form-group">
                <label for="coinName">Процент</label>
                <input type="number" class="form-control" id="percentage" name="percentage" aria-describedby="percentage" placeholder="Например: 5">


            </div>
            <div class="form-group">
                <label for="name">Воркер</label>
                <input type="text" class="form-control" id="worker" name="worker" aria-describedby="worker" placeholder="Например: @worker">
